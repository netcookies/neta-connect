...
- **🧩 小组件商店**：从 v1.7.9 开始支持云端动态下载和管理小组件。
...
从云端动态下载和管理小组件，无需更新 App 即可获得新功能。
...
3. 点击 **小组件商店**
4. 刷新列表查看可用小组件
5. 点击 **安装** 下载并安装你需要的小组件
6. 在 **已安装** 标签页中管理已安装的小组件

### 小组件资源

- **索引 URL**: `https://raw.githubusercontent.com/netcookies/neta-connect/main/widgets/index.json`
- **快速发布**: [widgets/QUICKSTART.md](./widgets/QUICKSTART.md)
- **完整开发指南**: [widgets/README.md](./widgets/README.md)

### 可用小组件

| 小组件 | 描述 | 状态 | 最新版本 |
|--------|------|------|----------|
| 电池(示例) | 动态小组件示例，演示基础功能 | 稳定版 | 1.0.0 |
...
- **完整开发文档**: [widgets/README.md](./widgets/README.md)
- **快速发布指南**: [widgets/QUICKSTART.md](./widgets/QUICKSTART.md)
- **示例代码**: 查看 `plugin-widgets` 模块（电池示例）
