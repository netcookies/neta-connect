...
- **快速开始**: [widgets/QUICKSTART.md](./widgets/QUICKSTART.md)
- **开发文档**: [widgets/README.md](./widgets/README.md)

### 可用小组件

| 小组件 | 描述 | 状态 | 最新版本 |
|--------|------|------|----------|
| 电池小组件 | 显示电池电量和续航信息 | 测试版 | 1.0.0 |

更多小组件正在开发中...

### 开发自己的小组件

欢迎开发者贡献新的小组件！详细开发指南请参考 [widgets/README.md](./widgets/README.md)。
